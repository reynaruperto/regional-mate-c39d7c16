...
const WHVWorkPreferences: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      setVisaLabel(visa.visa_type);

      // Parse sub_class + stage from visa_type string
      // e.g. "First Working Holiday Visa (417)" -> sub_class=417, stage=1
      let subClass = "";
      let stage = 1;
      if (visa.visa_type.includes("417")) subClass = "417";
      if (visa.visa_type.includes("462")) subClass = "462";
      if (visa.visa_type.toLowerCase().includes("second")) stage = 2;
      if (visa.visa_type.toLowerCase().includes("third")) stage = 3;

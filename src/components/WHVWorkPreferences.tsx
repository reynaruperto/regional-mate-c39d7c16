...
const WHVWorkPreferences: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // Eligible industries (✅ deduplicated)
  ...
  const handleContinue = async () => {
    ...
    // ✅ Deduplicate + save QLD-only locations
    const uniqueAreas = [...new Set(preferredAreas)];

  ...
  return (
    <div className="min-h-screen bg-gray-50 flex justify-center items-center p-4">
      <div className="w-[430px] h-[932px] bg-black rounded-[60px] p-2 shadow-2xl">
        {/* Phone Frame */}
        <div className="w-full h-full bg-white rounded-[48px] relative flex flex-col">
          {/* Dynamic Island */}
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            <div className="border-2 border-orange-500 rounded-2xl p-6 space-y-6">
              ...
              <div className="flex flex-col items-center">
                ...
                {visaData && (
                  <p className="text-xs text-gray-500">
                    {visaData.visa_stage?.label} • Expires{" "}
                    {formatDate(visaData.expiry_date)}
                  </p>
                )}
                {availableFrom && (
                  <p className="text-xs text-gray-500">
                ...
                {profileData.phone && (
                  <p className="text-sm text-gray-700 flex items-center mt-1">
                    <Phone size={14} className="mr-1 text-orange-500" />{" "}
                    {profileData.phone}
                  </p>
                )}
                {profileData.email && (
                  <p className="text-sm text-gray-700 flex items-center mt-1">
                    <Mail size={14} className="mr-1 text-orange-500" />{" "}
                    {profileData.email}
                  </p>
                )}
              </div>

...
import { ArrowLeft, Briefcase, MapPin, Award, User, Calendar, Globe, FileText } from "lucide-react";
        ...
        <div className="w-full h-full bg-white rounded-[48px] flex flex-col overflow-hidden relative">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            <div className="border-2 border-orange-500 rounded-2xl p-6 space-y-6">
              ...
              {/* Preferences, Experiences, Licenses, References */}
              {/* Repeat sections like in WHVPreviewMatchCard but orange themed */}

          ...
          <div className="flex-1 overflow-y-auto min-h-0 px-6 py-4">
            <div className="border-2 border-orange-500 rounded-2xl p-6 space-y-6">
              ...
              <div className="flex flex-col items-center">
                ...
                {profileData?.nationality && <p className="text-xs text-gray-500">{profileData.nationality}</p>}
                {profileData?.visaType && <p className="text-xs text-gray-500">{profileData.visaType}</p>}

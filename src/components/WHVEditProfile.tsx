...
const WHVEditProfile: React.FC = () => {
  ...
  // ---------------- Save Handler (same as last version) ----------------
  const handleSave = async () => {
    ...
    // (Save logic same as before, with state cast `as any` for TS2322 fix)
    // ...
  };
  ...
  // ---------------- Render ----------------
  // (render logic stays same as previous version with collapsibles)
};

      ...
      <div className="w-[430px] h-[932px] bg-black rounded-[60px] p-2 shadow-2xl relative">
        <div className="w-full h-full bg-white rounded-[48px] overflow-hidden relative flex flex-col">
          ...
          <div className="px-6 pt-16 pb-4 bg-white shadow-sm flex items-center justify-between">
            <Button variant="ghost" size="icon" className="w-10 h-10" onClick={() => navigate("/whv/browse-jobs")}>
          ...
          <div className="flex-1 px-6 py-6 overflow-y-auto">
            <div className="border-2 border-slate-800 rounded-2xl p-6 space-y-6">
              ...
              <div className="bg-gray-50 rounded-2xl p-4 mb-6">
                ...
                <p className="text-gray-900 font-semibold">{jobDetails.suburb_city}, {jobDetails.state} {jobDetails.postcode}</p>
              </div>
              ...
              {/* Heart Button */}
              <Button onClick={handleLikeJob} className="w-full bg-slate-800 hover:bg-slate-700 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-md">

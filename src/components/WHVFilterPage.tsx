  ...
  useEffect(() => {
    const fetchJobs = async () => {
      ...
      const mapped: JobCard[] = jobsData.map((job: any) => {
        ...
        return {
          job_id: job.job_id,
          company: job.company_name || "Employer not listed", // ✅ FIX
          profile_photo: photoUrl,
          role: job.role || "Role not specified",
          industry: job.industry || "General",
          location: job.location || "Location not specified",
          salary_range: job.salary_range || "Pay not disclosed",
          employment_type: job.employment_type || "Employment type not specified", // ✅ FIX
          description: job.description || "No description provided", // ✅ FIX
